	...
	<main class="newbook">
		...
		<div class="module">
			...
			<ol class="book-ol book-ol-normal">
				<li class="book-li" v-for="(item,index) in data.manito">
		...
		<div class="module">
			...
			<ol class="book-ol book-ol-normal">
				<li class="book-li" v-for="(item,index) in data.putaway">
					<router-link to="/details" class="book-layout">
						<img :src="item.src" alt="" class="book-cover"/>
						<div class="book-cell">
							<h4 class="book-title">{{item.title}}</h4>
		...
		<div class="module">
			...
			<ol class="book-ol book-ol-normal">
				<li class="book-li" v-for="(item,index) in data.bestsell">
					<router-link to="/details" class="book-layout">
						<img :src="item.src" alt="" class="book-cover"/>
						<div class="book-cell">
							<h4 class="book-title">{{item.title}}</h4>
